...
int main(void){
	...
	//CARGAS.
	double Vx0=0 , Vy0=0, q0 = 1, m0=1,  R0=3.0, Ran=40;  int i;
	
	//GENERA CONDICIONES INICIALES
	for(i=0;i<N;i++)  Carga[i].Inicie(Ran*cos(i*(2.0*M_PI)/N), Ran*sin(i*(2.0*M_PI)/N), Vx0, Vy0, q0, m0, R0);
	...
	double T=2*M_PI*sqrt(m0/Kcentral), t, dt=0.001, tmax=5*T;
